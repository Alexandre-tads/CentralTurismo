                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="input-group col flex-nowrap border-r-none">
                                ...
                                <input name="apelido" type="text" class="apelido form-control border-r-none" placeholder="Apelido" aria-label="apelido" aria-describedby="inputApelido" maxlength="9" min="9" value="<?php echo $usuario['apelido']; ?>">
                            </div>
                        </div>
